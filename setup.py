        ...
        ext_modules.append(
            CUDAExtension(name='syncbn',
                          sources=['csrc/syncbn.cpp',
                                   'csrc/welford.cu'],
                          extra_compile_args={'cxx': ['-O3'] + version_dependent_macros,
                                              'nvcc':['-O3'] + ['-fno-gpu-rdc']+['--amdgpu-target=gfx906']+ version_dependent_macros}))
    ...
    if torch.utils.cpp_extension.ROCM_HOME is None:
        ...
        ext_modules.append(
            CUDAExtension(name='bnp',
                          ...
                          include_dirs=[os.path.join(this_dir, 'csrc'),'/public/home/aiss/soft/Build/hipDNN/hipdnn/include'],
                          extra_compile_args={'cxx': [] + version_dependent_macros,
                                              'nvcc':['-L/public/home/aiss/soft/Build/hipDNN/hipdnn/lib','-lhipdnn',
                                                      '-I/public/home/aiss/soft/Build/hipDNN/hipdnn/include',
                                                      '-fPIC',
                                                      '-D__HIP_PLATFORM_HCC__=1',
                                                      '-DCUDA_HAS_FP16=1',
                                                      '-D__HIP_NO_HALF_OPERATORS__=1',
                                                      '-D__HIP_NO_HALF_CONVERSIONS__=1',
                                                      '-D__HIP_NO_HALF2_OPERATORS__'] + version_dependent_macros}))
