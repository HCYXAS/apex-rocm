...
void NhwcBatchNormAddRelu::fwdInference(hipStream_t stream) {
  ...
  hipLaunchKernelGGL(nhwc_batch_norm_fwd_inference<StorageType, THREADS_PER_CTA, THREADS_PER_PIXEL, ELEMENTS_PER_LDG, false, true>, dim3(grid_dim), dim3(THREADS_PER_CTA), 0, stream, params);
